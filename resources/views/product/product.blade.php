                        ...
                        @foreach($lastGames as $game)
                            <div class="products-columns__item">
                                <div class="products-columns__item__title-product">
                                    <a href="{{ route('product', ['id' => $game->id]) }}" class="products-columns__item__title-product__link">{{ $game->name }}</a>
                                </div>
                                <div class="products-columns__item__thumbnail">
                                    <a href="{{ route('product', ['id' => $game->id]) }}" class="products-columns__item__thumbnail__link">
